                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="active">
                            ...
                            <li id="list-news" onclick="router('list-news')"><a href="#"><i class="las fa-list"></i>List Post</a></li>
                                <li id="add-news" onclick="router('add-news')"><a href="#"><i class="las fa-plus"></i>Add Post</a></li>
                            </ul>
                        </li>
